...
from brax.envs import gridworld
...
from brax.envs import linear_system
...
_envs = {
    ...
    'ant': ant.Ant,
    'cartpole': inverted_pendulum.Cartpole,
    'fast': fast.Fast,
    'fetch': fetch.Fetch,
    'grasp': grasp.Grasp,
...
def create(env_name: str,
           episode_length: Union[int, None] = 1000,
           action_repeat: int = 1,
           auto_reset: bool = True,
           batch_size: Optional[int] = None,
           deterministic_reset: Optional[bool] = True,
  ...
  if auto_reset:
    env = wrappers.AutoResetWrapper(env, deterministic_reset)
